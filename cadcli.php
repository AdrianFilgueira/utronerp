...
<!---------------------------------------------------------------------------------------------->
				    ...
				    <div class="form-group col-md-2">
					    ...
					    <select type="text" id="tipopessoa" name="tipopessoa" class="custom-select d-block w-100" onmouseup="document.getElementById('cpfcnpj').value='';document.getElementById('ierg').value='';" required>
				    ...
				    <div class="form-group col-md-10">
				 	...
				 	<div class="center">
<!--------------------------------------------------------------------------------------------------------------------------------->
						<input type="submit" name="btnCadCli" value="Cadastrar" class="btn btn-success"><br><br>				
					</div>	
				</form>		
				</div>	
